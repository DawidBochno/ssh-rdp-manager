...
TEXTS = {
    "en": {
        ...
        # --- skaner sieci ---
        "menu_tools": "Tools",
        "menu_network_scanner": "Network scanner…",
        "scanner_title": "Network scanner",
        "scanner_title_done": "Network scanner — hosts found: {0}",
        "scanner_range": "Range:",
        "scanner_start": "Scan",
        "scanner_stop": "Stop",
        "scanner_bad_range": "Enter a range like 192.168.0.1-100 or 192.168.0.0/24 ({0}).",
        "scanner_col_name": "Name",
        "scanner_col_ip": "IP",
        "scanner_col_mac": "MAC address",
        ...
        # --- skrypty użytkownika ---
        # --- tunele, wyzwalacze, zakladki katalogow ---
        "fld_passphrase": "Key passphrase:",
        "tip_passphrase": "Password of the encrypted private key — not the account password.",
        "fld_jump_host": "Jump host (ProxyJump):",
        "ph_jump_host": "e.g. bastion.example.com or bastion.example.com:2222",
        "tip_jump_host": "Connect through this host first, using the same account/key as the target.",
        "sftp_edit": "Edit",
        "menu_theme": "Terminal color scheme",
        "menu_dark_mode": "Dark window theme",
        ...
        "sftp_no_bookmarks": "(no bookmarks)",
        "sftp_add_bookmark": "Bookmark this folder",
        "sftp_del_bookmark": "Remove this bookmark",
        "menu_tunnels": "SSH tunnels…",
        "tunnel_title": "SSH tunnels",
        "tunnel_hint": "Format: L 8080:10.0.0.5:80 (local) or R 9000:127.0.0.1:22 (remote).",
        "tunnel_add": "Add",
        "tunnel_remove": "Remove",
        "tunnel_bad": "Unknown format. Use: L 8080:host:80 or R 9000:host:22.",
        "tunnel_error": "Could not open the tunnel:\n\n{0}",
        "tunnels_need_session": "Open an SSH session first.",
        "tunnel_restore_failed": "Some tunnels did not start: {0}",
        "err_user_scripts": "Could not read scripts.json:\n\n{0}",
        # --- podglad logu na zywo i menedzer uslug ---
        "menu_logtail": "Live log tail…",
        "logtail_title": "Live log tail",
        "logtail_prompt": "Remote file path:",
        "logtail_filter_placeholder": "Filter (regex)…",
        "log_tab_title": "Log: {0}",
        "menu_services": "Services…",
        "services_title": "Services",
        "services_col_name": "Name",
        "services_col_status": "Status",
    ...
    "pl": {
        ...
        # --- skaner sieci ---
        "menu_tools": "Programy",
        "menu_network_scanner": "Skaner sieci…",
        "scanner_title": "Skaner sieci",
        "scanner_title_done": "Skaner sieci — znaleziono hostów: {0}",
        "scanner_range": "Zakres:",
        "scanner_start": "Skanuj",
        "scanner_stop": "Zatrzymaj",
        "scanner_bad_range": "Podaj zakres w rodzaju 192.168.0.1-100 albo 192.168.0.0/24 ({0}).",
        "scanner_col_name": "Nazwa",
        "scanner_col_ip": "IP",
        "scanner_col_mac": "Adres MAC",
        ...
        # --- skrypty użytkownika ---
        # --- tunele, wyzwalacze, zakladki katalogow ---
        "fld_passphrase": "Hasło klucza:",
        "tip_passphrase": "Hasło zaszyfrowanego klucza prywatnego — nie hasło konta.",
        "fld_jump_host": "Serwer skoku (ProxyJump):",
        "ph_jump_host": "np. bastion.example.com albo bastion.example.com:2222",
        "tip_jump_host": "Łączy się najpierw przez ten host, tym samym kontem/kluczem co cel.",
        "sftp_edit": "Edytuj",
        "menu_theme": "Schemat kolorów terminala",
        "menu_dark_mode": "Ciemny motyw okna",
        ...
        "sftp_no_bookmarks": "(brak zakładek)",
        "sftp_add_bookmark": "Dodaj ten katalog",
        "sftp_del_bookmark": "Usuń tę zakładkę",
        "menu_tunnels": "Tunele SSH…",
        "tunnel_title": "Tunele SSH",
        "tunnel_hint": "Format: L 8080:10.0.0.5:80 (lokalny) albo R 9000:127.0.0.1:22 (zdalny).",
        "tunnel_add": "Dodaj",
        "tunnel_remove": "Usuń",
        "tunnel_bad": "Nieznany format. Użyj: L 8080:host:80 albo R 9000:host:22.",
        "tunnel_error": "Nie udało się otworzyć tunelu:\n\n{0}",
        "tunnels_need_session": "Najpierw otwórz sesję SSH.",
        "tunnel_restore_failed": "Część tuneli nie wstała: {0}",
        "err_user_scripts": "Nie udało się odczytać scripts.json:\n\n{0}",
        # --- podglad logu na zywo i menedzer uslug ---
        "menu_logtail": "Podgląd logu na żywo…",
        "logtail_title": "Podgląd logu na żywo",
        "logtail_prompt": "Ścieżka do pliku na serwerze:",
        "logtail_filter_placeholder": "Filtr (regex)…",
        "log_tab_title": "Log: {0}",
        "menu_services": "Usługi…",
        "services_title": "Usługi",
        "services_col_name": "Nazwa",
        "services_col_status": "Status",
        "services_start": "Uruchom",
        "services_stop": "Zatrzymaj",
        "services_restart": "Uruchom ponownie",
