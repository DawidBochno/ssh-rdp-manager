...
TEXTS = {
    "en": {
        ...
        "fld_tags": "Tags:",
        "ph_tags": "e.g. prod, db, client-x — filter with #tag",
        "btn_test_connection": "Test connection",
        "test_ok": "Connection works — credentials accepted.",
        ...
        "fld_credential": "Credential:",
        "cred_none": "(none — fields below)",
        "cred_new": "New…",
        "cred_title": "Credential",
        "cred_need_name": "Give the credential a name.",
        "cred_load_failed": "credentials.json is damaged, a copy was saved as .json.bak:\n{0}",
        "cred_add": "Add…",
        "cred_edit": "Edit…",
        "cred_delete": "Delete",
        "cred_row": "{0} — {1}  (connections: {2})",
        "cred_delete_confirm": "Delete credential {0}? Connections using it: {1}. They will fall back to their own login fields.",
        "tip_credential": "\nCredential: {0}",
        "menu_multirun": "Command on many servers…",
        "multirun_title": "Command on many servers",
        "multirun_servers": "Open SSH sessions to run on:",
        "multirun_own_command": "Custom command",
        "multirun_command_ph": "Command, e.g. uptime",
        "multirun_run": "Run",
        "multirun_empty": "Type a command.",
        "multirun_need_param": "This script needs a parameter.",
        "multirun_no_targets": "Tick at least one server.",
        "multirun_progress": "Done {0}/{1}, errors: {2}",
        "multirun_ok": "OK",
        "multirun_err": "ERROR",
        "multirun_busy": "Still running — wait for the remaining servers.",
        "multirun_default_name": "multirun.txt",
        "disks_title": "Disks",
    ...
    "pl": {
        ...
        "menu_processes": "Procesy…",
        "processes_title": "Procesy",
        "processes_col_user": "Użytkownik",
        ...
        "fld_tags": "Tagi:",
        "ph_tags": "np. prod, db, klient-x — filtr przez #tag",
        "btn_test_connection": "Połącz na próbę",
        "test_ok": "Połączenie działa — dane logowania przyjęte.",
        ...
        # --- panel dyskow ---
        "menu_disks": "Dyski…",
        "menu_credentials": "Poświadczenia…",
        "fld_credential": "Poświadczenie:",
        "cred_none": "(brak — pola poniżej)",
        "cred_new": "Nowe…",
        "cred_title": "Poświadczenie",
        "cred_need_name": "Nadaj poświadczeniu nazwę.",
        "cred_load_failed": "Plik credentials.json jest uszkodzony, kopię odłożono jako .json.bak:\n{0}",
        "cred_add": "Dodaj…",
        "cred_edit": "Edytuj…",
        "cred_delete": "Usuń",
        "cred_row": "{0} — {1}  (połączeń: {2})",
        "cred_delete_confirm": "Usunąć poświadczenie {0}? Korzystających połączeń: {1}. Wrócą do własnych pól logowania.",
        "tip_credential": "\nPoświadczenie: {0}",
        "menu_multirun": "Polecenie na wielu serwerach…",
        "multirun_title": "Polecenie na wielu serwerach",
        "multirun_servers": "Otwarte sesje SSH, na których uruchomić:",
        "multirun_own_command": "Własne polecenie",
        "multirun_command_ph": "Polecenie, np. uptime",
        "multirun_run": "Uruchom",
        "multirun_empty": "Wpisz polecenie.",
        "multirun_need_param": "Ten skrypt wymaga parametru.",
        "multirun_no_targets": "Zaznacz co najmniej jeden serwer.",
        "multirun_progress": "Gotowe {0}/{1}, błędów: {2}",
        "multirun_ok": "OK",
        "multirun_err": "BŁĄD",
        "multirun_busy": "Jeszcze trwa — poczekaj na pozostałe serwery.",
        "multirun_default_name": "wiele_serwerow.txt",
        "disks_title": "Dyski",
